...
<p  align="center"><a href="home.php?action=pdetails">Go back</a></p>
<?php  
...
color: rgb(50, 50, 50); float:right; margin-top:-40px;"><?php
			...
			$result=mysqli_query($connection,"select * from user where username='$user_id'")or die(mysqli_error);
...
$cal->addEvent('NO SCHEDULE AVAILABLE', 28);
